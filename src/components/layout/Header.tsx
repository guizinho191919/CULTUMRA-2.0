...
const Header = () => {
  ...
  const handleSearchFocus = () => {
    ...
    // Abrir o modal quando o campo for clicado
  ...
  const handleModalSearch = (filters: {
    ...
    // Construir a query string com todos os filtros
            ...
            <div className={`transition-all duration-300 ${
              ...
              <form onSubmit={handleSearch} className="relative">
                <Input
                  ...
                  className={`transition-all duration-200 cursor-pointer ${showSearchIcon ? 'pl-10' : 'pl-3'} ${isSearchExpanded ? 'pr-10' : 'pr-3'}`}
                  value={searchTerm}
